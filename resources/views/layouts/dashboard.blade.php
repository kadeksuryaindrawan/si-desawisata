...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('dashboard/images/logo/logo.svg') }}" alt="Logo" srcset=""></a>
            ...
            <header class="mb-3">
                <div class="row">
                    ...
                    <div class="col-4 mt-2">
                        <p class="text-black float-end">Selamat Datang, <strong>{{ Auth::user()->name }} !</strong></p>
                    </div>
