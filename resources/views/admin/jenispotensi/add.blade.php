            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Form Tambah Jenis Potensi</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('jenispotensi.store') }}" method="POST" class="form form-vertical">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="email-id-vertical" class="form-control"
                                                    name="nama_jenis_potensi" placeholder="Nama Jenis Potensi">
                                            </div>
                                        </div>
